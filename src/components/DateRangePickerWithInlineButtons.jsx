...
const DateRangePickerWithInlineButtons = () => {
  ...
  const renderCalendar = () => {
    ...
    for (let i = 1; i <= daysInMonth; i++) {
      ...
      const dayString = day.toLocaleDateString("es-ES");
      let className =
                  ...
                  <div className="relative" ref={datepickerRef}>
                    ...
                    {isOpen && (
                      <div
                        ...
                        className="shadow-datepicker absolute mt-2 rounded-xl border border-stroke bg-white pt-5 dark:border-dark-3 dark:bg-dark-2 z-50 w-full max-w-sm"
                      >
