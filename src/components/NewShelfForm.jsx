...
export default function NewShelfForm({formData, handleChangeForm, setFormData}){
    ...
    const selectionSet = ["id", "tipo", "opciones.*"];
    ...
    return (
        <Stack gap={2} className="w-full">
            ...
            <Autocomplete
                ...
                onInputChange={handleChangeForm("tipo")}
                renderInput={(params) => (
            ...
            <div>
                ...
                <List>
                    <IncidentReport title={"Ins. Estática"} withPosition={true} formData={formData.incidencias?.estatica} changeIncidencias={changeIncidencias("estatica")} incidenciasPredeterminadas={incidenciasPredeterminadas.ESTATICA}/>
                    <IncidentReport title={"Ins. Estado de la Carga"} withPosition={false} formData={formData.incidencias?.carga} changeIncidencias={changeIncidencias("carga")} incidenciasPredeterminadas={incidenciasPredeterminadas.CARGA}/>
                    <IncidentReport title={"Ins. de Montaje"} withPosition={false} formData={formData.incidencias?.montaje} changeIncidencias={changeIncidencias("montaje")} incidenciasPredeterminadas={incidenciasPredeterminadas.MONTAJE}/>
                    <IncidentReport title={"Ins. Documental"} withPosition={false} formData={formData.incidencias?.documental} changeIncidencias={changeIncidencias("documental")} incidenciasPredeterminadas={incidenciasPredeterminadas.DOCUMENTAL}/>
                </List>
            </div>
        </Stack>
    )
